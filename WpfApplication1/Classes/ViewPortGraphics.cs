...
namespace ParSurf
{
    public class ViewPortGraphics
    {
        ...
        public void generate_3d_axes(int renderResolution)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                axes[i] = ParametricSurface.getAxis(i);
            }
                                            ...
                                            double opacity, Transform3D currentTransform = null)
        {
            ...
            this.viewPort.Dispatcher.BeginInvoke(new Action(() => { Mouse.OverrideCursor = Cursors.Arrow; }), DispatcherPriority.SystemIdle, null);
        }
